...
Join my [news channel](t.me/publicfille)to get information on all the latest updates.
...
There are two ways of paying him; [UPI](t.me/sendpayments), or [Crypto](t.me/sendpayments)."""
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="👨‍💻 Devloper", url="https://t.me/ifeelscam")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/offchats"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/publicfille")],
                     [InlineKeyboardButton(text="File Share bot", url="https://t.me/publicfilesharerobot"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
